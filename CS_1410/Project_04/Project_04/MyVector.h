...
public:
	...
	*/
	...
	Returns: Deconstructors do not return.
	Pre-conditions:
	Post-conditions:
	-------------------------
	*/
	...
	*/
	...
	Pre-conditions:
	Post-conditions: Deletes all of the elements from the vector and resets its size to zero and its capacity to two.
	-------------------------
	*/
	void clear();
	...
	Parameters: The integer value n to be added to the end of the vector.
	Returns: Void does not return.
	Pre-conditions:
	Post-conditions:
	-------------------------
	*/
	...
	Parameters:
	Returns: The value of the integer stored at index n of the vector.
	Pre-conditions:
	Post-conditions:
	-------------------------
	*/
